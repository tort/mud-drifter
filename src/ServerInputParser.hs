...
parseZone = listToMaybe <$> many' zoneLine
  where
    ...
    zoneLine =
      C.endOfLine *>
      choice zoneNames >>= \zoneName ->
        C.space *>
        C.char '(' *>
        A.skipWhile (not . C.isEndOfLine) *>
        C.endOfLine *>
        (pure . decodeUtf8) zoneName
    zoneNames =
      string . encodeUtf8 <$>
      [ "Лесная деревня (1-ая родовая)"
      , "Пожня у деревни"
      , "Раменье"
      , "Болотце у околицы"
      , "Темный лес"
      ...
      , "На реке"
      , "На дороге"
      , "Сказка для чернокнижника"
      , "Степная деревня (3-я родовая)"
      , "Развалившаяся банька"
      , "Сторожевая башня"
      , "Сказочный пустырь"
      , "Сказка для охотника"
      , "Огороды"
      , "Степь у деревни"
      , "Погост Холуй (5-ая родовая)"
      , "Заброшенная мельница"
      , "Лесное болото"
      , "Глухой лес"
      , "Грибная поляна"
      , "Деревня \"Беличья Падь\" (4-ая родовая)"
      , "Птичий двор"
      , "Где-то в лесу"
      , "Деревушка \"Медвежья гора\" (6-ая родовая)"
      , "Два кладбища"
      , "Жихарка"
      , "Соловей-разбойник"
      , "У Соловья в доме"
      ...
      , "Разбойничий притон"
      , "Мятежная деревня"
      , "Охотничьи угодья Князя 2"
      , "Просека перед охотничьими угодьями"
      , "Охотничьи угодья Князя"
      , "Сказочный темный лес (\"Хозяин леса\")"
      , "Кровавый Ворон"
      , "В гостях у сказки"
      , "Сказочный край"
      , "Сказка для богатыря"
      , "Обезлюдевший хутор"
      , "Пещеры Ночного Дозора"
      , "Сказка лесных кошмаров"
      , "Сказка для волшебника"
      , "Избушка на курьих ножках"
      , "Чудская деревня"
      , "Зачарованный город"
      , "Сказка о кузнеце-змееборце"
      , "Про Федота-стрельца"
      , "Необитаемый остров"
      , "Летучий корабль"
      , "Сказка для татя"
      , "Кладбище"
      , "Сказка для кудесника"
      , "Хоромы тверского боярина"
      , "Арена бешеных эскимосов. Расположена: проход через ренты во время турниров. Группа: 20"
      , "Лесной край"
      , "В скифской усыпальнице"
      , "Япония"
      , "Япония 2"
      , "Сгоревший хутор"
      , "Склеп"
      , "Осада Китеж-града. Примерный уровен 29"
      , "Волчий лес"
      , "Деревенский Колодец"
      , "Старая каменоломня"
      , "Купеческий двор у Торжка"
      , "Дорога к Ижорской деревне"
      , "Посолонь (Времена Года)"
      , "Лагерь бешеных колобков"
      , "Окрестности Переяславля"
      , "Дорога по степи (Переяславль-Чернигов)"
      , "Дорога в лесу 1 (Переяславль-Чернигов)"
      , "Дорога в лесу 2 (Переяславль-Чернигов)"
      , "История о хрустальном шаре"
      , "Черное болото"
      , "Дорога к Замку Нежити"
      , "Логово минотавров"
      , "Свадьба на хуторе"
      , "Проклятая деревня"
      , "Поля и пастбища у Корсуни"
      , "Разбойничий лес"
      , "Заколдованный лес"
      , "Стоянка половцев"
      , "Боярская застава у Твери"
      ...
      , "Травень остров"
      , "Священный дуб"
      , "Финист-ясен сокол. Прмерный уровень: 20"
      , "Буратино"
      , "Дорога в Ладогу"
      , "Остров Валаам"
      , "Странный Лес"
      , "Дом Кудесницы Марьи"
      , "Снежная королева"
      , "Князь Велесур и деревня язычников"
      , "Морская стихия"
      , "Рыбацкая весь"
      , "Подводное царство"
      , "Подводный город"
      ...
      , "Застава Черномора"
      , "Погоревший лес"
      , "Замок Кащея бессмертного"
      , "Хоромы брянского боярина"
      , "Мельня"
      , "Зелье желаний"
      , "Сожженный лес"
      , "Черная дорога. Примерый уровень: 28"
      , "Погост у озера"
      , "Дурман-трава"
      ...
      , "Подземный город"
      , "Погребенный город"
      , "Лагерь отшельников Ночного Дозора"
      , "Ганзейский двор"
      , "На Ильмень-озере"
      , "После Садко"
      , "Топи"
      ...
      , "Тотьма"
      , "Варяжская деревня"
      , "Горемычная деревушка"
      , "Воровская гильдия в Тотьме"
      , "Лесной лабиринт"
      , "Дорога предков"
      , "Замороченный лес"
      , "Вышгород-Боярские хоромы"
      , "Древние катакомбы под Тотьмой."
      , "Новое брянское кладбище"
      , "Тверская деревня. Приерный уровень: 28"
      , "Приднепровское селение"
      , "Новгородский гостиный двор "
      , "Деревня в Новгородских лесах"
      , "Замок темного мага"
      , "Муромская деревня"
      , "На реке Горынь"
      , "Купеческая арена"
      ...
      , "Купеческий двор"
      , "Туманный лес"
      , "Крепость Слободка близ Переяславля"
      , "На распутье (первая зона ада)"
      , "Марин Чертог"
      , "Велесова Земля (Край Велеса)"
      , "Школа волхвов"
      , "Перунова Крепь"
      , "Форпост викингов"
      , "Словенская деревня(Курган)"
      , "Сказочный сон"
      , "Мед поэзии"
      , "Хозяйка медной горы"
      , "Медные рудники"
      , "Четыре стихии. Расположена: севернее Курска. Группа: 12"
      , "Веска Белай Русi"
      , "Подземный Замок Проклятых"
      , "Путь в Темную долину"
      , "Пустошь людских страхов(Темная долина)"
      , "Пещеры Вечного Холода (Темная долина)"
      , "Новая мад-школа"
      , "Заповедный лес"
      , "Трактир в курской деревне"
      , "Лукоморья больше нет"
      , "Деревня ремесленников"
      , "Бескиды (Карпаты). Где-то около реки Черемош. "
      , "Дальний север"
      , "Лапландский колдун"
      , "Гильдия душегубов"
      , "Торговая лодья"
      ...
      , "Ростов Великий (Пригород)"
      , "Замок тевтонских рыцарей"
      , "Военный лагерь Миндовга"
      , "Таинственное поместье"
      , "Волшебный сад"
      , "Медное, серебряное и золотое царства"
      , "Самоцветные горы 2 - подземные рудники"
      , "Ливонский лагерь"
      , "Тридевятое царство"
      , "Зов крови 1. Примерныйуровень: 30"
      , "Дорога к рипеям I (рипеи-1)"
      , "Ер-боко-каан"
      , "Вий"
      , "Курская деревня"
      , "Аримаспы"
